...
- GitHub, [*How to write a great agents.md: lessons from over 2,500 repositories*](https://github.blog/ai-and-ml/github-copilot/how-to-write-a-great-agents-md-lessons-from-over-2500-repositories/): the ~150-line cap (beyond it, ~20% higher inference cost with no performance gain), commands/boundaries as the highest-ROI sections, and earlier-lines-carry-more-weight ordering.
